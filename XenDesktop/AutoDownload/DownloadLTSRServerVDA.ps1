...
$download = Invoke-WebRequest -Uri ('https://secureportal.citrix.com/Licensing/Downloads/UnrestrictedDL.aspx?DLID=15440&URL=https://downloads.citrix.com/15440/VDAServerSetup_7_15_4000.exe') -WebSession $websession -UseBasicParsing -MaximumRedirection 100 -Verbose -Method GET
$webform = @{
"chkAccept" = "on"
