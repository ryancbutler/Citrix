#Downloads Citrix CVAD LTSR 7.15 CU 4 Workstation VDA
...
#Download
Invoke-WebRequest -Uri ("https://secureportal.citrix.com/Licensing/Downloads/UnrestrictedDL.aspx?DLID=15441&URL=https://downloads.citrix.com/15411/VDAWorkstationSetup_7_15_4000.exe") -WebSession $websession -Method POST -Body $webform -ContentType "application/x-www-form-urlencoded" -UseBasicParsing -OutFile $downloadpath -Verbose
