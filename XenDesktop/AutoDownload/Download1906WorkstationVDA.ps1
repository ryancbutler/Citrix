...
$download = Invoke-WebRequest -Uri ('https://secureportal.citrix.com/Licensing/Downloads/UnrestrictedDL.aspx?DLID=16111&URL=https://downloads.citrix.com/16111/VDAWorkstationSetup_1906.exe') -WebSession $websession -UseBasicParsing -MaximumRedirection 100 -Verbose -Method GET
$webform = @{
    "chkAccept" = "on"
